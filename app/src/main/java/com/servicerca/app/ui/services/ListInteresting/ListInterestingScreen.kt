...
fun ListInteresting(
    ...
    val viewModel = hiltViewModel<ListInterestingViewModel>()
    val services by viewModel.interestingServices.collectAsStateWithLifecycle()
        ...
        LazyColumn(
            ...
            items(
                ...
                InterestingServiceCard(
                    ...
                    rating = 0f,
                    isFavorite = true,
                    onFavoriteClick = { viewModel.onRemoveBookmark(service.id) }
                )
            }
            ...
            if (filteredServices.isEmpty()) {
                item {
                    Text(
                        text = "No tienes servicios guardados.",
